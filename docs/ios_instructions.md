...
- apiBaseUrl: You need to point to the Python server, not the node server that hosts the web front end. Python server runs on port 8000 by default (and you have to make sure this port is accessible through your firewall).
